...
void main() {
  final FirebaseAuthGamesServicesPlatform initialPlatform = FirebaseAuthGamesServicesPlatform.instance;

  test('$MethodChannelFirebaseAuthGamesServices is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelFirebaseAuthGamesServices>());
  });

  test('getPlatformVersion', () async {
    FirebaseAuthGamesServices firebaseAuthGamesServicesPlugin = FirebaseAuthGamesServices();
    MockFirebaseAuthGamesServicesPlatform fakePlatform = MockFirebaseAuthGamesServicesPlatform();
